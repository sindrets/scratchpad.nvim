local oop = require("scratchpad.oop")
...
---@class ArgObject : scratchpad.Object
...
---@alias FlagValueMap.CompletionProducer string[]|fun(name_lead: string, arg_lead: string): string[]

---@class FlagValueMap : scratchpad.Object
---@field map table<string, FlagValueMap.CompletionProducer>
...
---@param producer? FlagValueMap.CompletionProducer
...
---@return FlagValueMap.CompletionProducer
...
---@field allow_quoted boolean
---@field allow_ex_range boolean
