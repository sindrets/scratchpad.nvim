...
---@generic T : scratchpad.Class
---@param class T
---@return string
local function class_path(class)
  ---@cast class scratchpad.Class
  local s
  local cur = class
...
---Create a new class.
---@generic T : scratchpad.Object
---@param name `T`
---@param super_class? scratchpad.Object
---@return T
